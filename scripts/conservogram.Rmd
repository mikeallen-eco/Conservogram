---
title: "Make your own 'conserv-o-gram'"
output:
...
You can save the last graph you made to a jpg or various other formats (just change the extension) using the following command.
